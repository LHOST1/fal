...
class _FalciState extends State<Falci> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: Center(child: Text("FALCI BACIM")),
        ),
        body: Column(
          children: [
            Center(child: Container(child: Image.asset("assets/falci.png"))),
            SizedBox(
              height: 15,
            ),
            ElevatedButton(
